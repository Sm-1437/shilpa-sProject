...
public class MedcountDATA {
    ...
    @Expose
    private List<Medcountlist> listdata = null;
    ...
    public List<Medcountlist> getListdata() {
        return listdata;
    }

    public void setListdata(List<Medcountlist> listdata) {
