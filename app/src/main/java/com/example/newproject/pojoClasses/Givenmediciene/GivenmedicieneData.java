...
public class GivenmedicieneData {
    ...
    @Expose
    private List<GivenmedicieneList> listdata = null;
    ...
    public List<GivenmedicieneList> getListdata() {
        return listdata;
    }

    public void setListdata(List<GivenmedicieneList> listdata) {
