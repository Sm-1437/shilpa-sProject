...
package com.example.newproject.tableview;
...
import com.example.newproject.tableview.holder.ColumnHeaderViewHolder;
import com.example.newproject.tableview.popup.ColumnHeaderLongPressPopup;
import com.example.newproject.tableview.popup.RowHeaderLongPressPopup;
...
public class TableViewListener implements ITableViewListener {
    ...
    public void onRowHeaderClicked(@NonNull RecyclerView.ViewHolder rowHeaderView, int row) {
        ...
        Log.d(TAG, "onCellClicked: 7");
//        Intent i= new Intent(mContext, AssitedLivingFacilityActivity.class);
